...
-- 초기 워커 데이터 삽입 (IP는 팀 환경에 맞게 수정)
INSERT INTO worker_nodes (name, display_name, url) VALUES
    ('skin',   '피부 진단 서버',   'http://192.168.0.101:8000'),
    ('brain',  '뇌종양 진단 서버', 'http://192.168.0.102:8000'),
    ('eyes',   '안과 진단 서버',   'http://192.168.0.103:8000'),
    ('spine',  '척추 진단 서버',   'http://192.168.0.104:8000'),
    ('kidney', '신장 진단 서버',   'http://192.168.0.105:8000'),
    ('colon',  '대장암 진단 서버', 'http://192.168.0.106:8000');